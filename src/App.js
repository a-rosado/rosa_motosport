...
// Rosa Motosport
const RosaVertical = lazy(() => import("./Pages/Rosa-motosport/RosaMotosport"))
const RosaMotosportAboutUs = lazy(() => import("./Pages/Rosa-motosport/RosaMotosportAboutUs"))
const RosaMotosportContactUs = lazy(() => import("./Pages/Rosa-motosport/RosaMotosportContactUs"))
const RosaMotosportInventory = lazy(() => import("./Pages/Rosa-motosport/RosaMotosportInventory"))
const SingleProduct = lazy(() => import("./Pages/Rosa-motosport/Components/Zx4rProduct"))
      ...
      <div className="App" style={{ "--header-height": `${headerHeight}px` }}>
        {
          <main style={{ marginTop: headerHeight, marginBottom: footerHeight }}>
            ...
            <AnimatePresence exitBeforeEnter>
              <Suspense fallback={<></>}>
                <Routes>
                  <Route path="/" element={<RosaVertical />} />
                  {/* Rosa Motosport Routes (Except landing page, landing page is in line 362) */}
                  <Route path="/Rosa-motosport-RosaMotosportAboutUs" element={<RosaMotosportAboutUs style={{ "--base-color": "#0038e3" }} />} />
                  <Route path="/Rosa-motosport-RosaMotosportContactUs" element={<RosaMotosportContactUs style={{ "--base-color": "#0038e3" }} />} />
                  <Route path="/Rosa-motorsport-RosaMotosportInventory" element={<RosaMotosportInventory style={{ "--base-color": "#0038e3" }} />} />
